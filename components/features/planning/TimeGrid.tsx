          ...
          {scheduledTasks.map((task) => {
            ...
            return (
              <DraggableTask key={task.id} task={task}>
                <div
                  className={`group/card absolute right-4 left-20 flex cursor-grab flex-col justify-between rounded-xl border p-3 text-xs shadow-sm transition-all hover:z-30 hover:scale-[1.01] ${
                    isDone
